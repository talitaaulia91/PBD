  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <!-- End Navbar -->
              ...
              <div class="row col-md-6"> 
                <h6 class="font-weight-bolder mb-0">Pilih Data Kendaraan</h6>
                <!-- <a href="" class="btn bg-gradient-secondary w-100 mt-4 mb-0">Masukkan keranjang</a> -->
                <form method="post" action="">
                <div class="form-group  mb-0">
                <label for="exampleInputPassword1">NO STNK</label>
                    <select class="form-select" name="no_stnk">
                        <option value="">Pilih No STNK</option>
                            <?php
                            $no_stnk = $mysqli->query("SELECT k.* FROM kendaraan k, pemilik p 
                                                    WHERE k.ID_Pemilik = p.ID_Pemilik 
                                                    AND p.Email = '".$_SESSION['user_email']."'");
                            while ( $no = $no_stnk->fetch_assoc()){
                            ?>
                            <option value="<?php echo $no['NO_STNK'] ?>">
                              <?php 
                              echo $no['NO_STNK'];
                              ?>
                            </option>
                ...
                <a class="btn bg-gradient-warning mt-4 mb-3" href="form_kendaraan.php">Tambah kendaraan</a>
                <button type="submit" name="checkout" value="checkout" class="btn bg-gradient-info mt-4 mb-3">Beli Sekarang</button>
              </form>
              </div>
              </div>
