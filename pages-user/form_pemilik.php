  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <!-- End Navbar -->
              ...
              <form method="post" action="">
                ...
                <input type="text" name="nama_pemilik"class="form-control" placeholder="Masukkan Nama">
                </div>
                <div class="form-group  mb-0">
                <label for="exampleInputPassword1">Alamat</label>
                <input type="text" name="alamat_pemilik"class="form-control" placeholder="Masukkan Alamat">
                </div>
                <div class="form-group  mb-0">
                <label for="exampleInputPassword1">Telepon</label>
                <input type="text" name="telp_pemilik"class="form-control" placeholder="Masukkan Telepon">
                </div>
                <br></br>
