  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.php" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">SIGMA SPEED</span>
      </a>
    </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="row col-md-6"> 
              ...
              <form method="post" action="">
                ...
                <input type="email" class="form-control" readonly value="<?php echo $_SESSION['user_email'];?>" required>
                </div>
                ...
                <input type="text" name="alamat_pemilik"class="form-control" placeholder="Masukkan Alamat" required>
                </div>
                <div class="form-group  mb-0">
                <label for="exampleInputPassword1">Telepon</label>
                <input type="text" name="telp_pemilik"class="form-control" placeholder="Masukkan Telepon" required>
                </div>
                <br></br>
                ...
                <input type="text" name="no_stnk"class="form-control" placeholder="Masukkan Nomor STNK" required>
                </div>
                ...
                <input type="text" name="no_rangka"class="form-control" placeholder="Masukkan no rangka" required>
                </div>

                <div class="form-group  mb-0">
                <label for="exampleInputPassword1">No Mesin</label>
                <input type="text" name="no_mesin"class="form-control" placeholder="Masukkan no mesin" required >
                </div>
              ...
              <?php
                ...
                $telp_pemilik   = $_POST['alamat_pemilik'];
