          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              ...
              <form role="form text-left" action="" method="POST">
                ...
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="Confirm Password" name="kpassword" aria-label="Password" aria-describedby="password-addon">
                </div>
                ...
                <div class="text-center">
                  <button type="submit" name="register" value="REGISTER" class="btn bg-gradient-dark w-100 my-4 mb-2">Sign up</button>
                </div>
