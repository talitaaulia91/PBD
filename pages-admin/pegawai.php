...
$query_pegawai = "SELECT p.ID_Pegawai, p.Nama_Pegawai, j.Nama_Jabatan, p.Email, p.Alamat_Pegawai, p.Tlp_Pegawai
                    FROM pegawai p JOIN jabatan j
                    ON p.id_jabatan = j.id_jabatan ";
$tabel_pegawai = mysqli_query($mysqli, $query_pegawai);
?>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="?hal=billing">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                 ...
                 <tbody>
                    ...
                    <?php
                     foreach ($tabel_pegawai as $data_pegawai) : 
                    ?>
                    <tr>
                      ...
                      <?php echo $data_pegawai['ID_Pegawai'];  ?> 
                     </span>
                    </td>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="text-s font-weight-bold mb-0">
                        <?php echo $data_pegawai['Nama_Jabatan'];  ?> 
                        </span>
                      </td>

                      <td class="align-middle text-center text-sm">
                        <span class="text-s font-weight-bold mb-0">
                        <?php echo $data_pegawai['Alamat_Pegawai'];  ?> 
                        </span>
                      </td>

                      <td class="align-middle text-center">
                        <span class="text-secondary text-s font-weight-bold">
                        <?php echo $data_pegawai['Tlp_Pegawai'];  ?> 
                        </span>
                      </td>
