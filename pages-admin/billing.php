...
$view_billing = mysqli_query($mysqli, $query_billing);
$counter = 1;
?>
        ...
        <div class="col-md-11 mt-4">
          <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                  <?php
                     foreach ($view_billing as $data_billing) : 
                    ?>
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    <h6 class="mb-3 text-sm">
                    <?php echo $data_billing['id_pkb'];  ?> 
                    </h6>
                    <span class="mb-2 text-xs">
                      Nama customer &emsp;&emsp;: 
                      <span class="text-dark font-weight-bold ms-sm-2">
                      <?php echo $data_billing['nama_pemilik'];  ?> 
                      </span></span>
                      ...
                      <span class="mb-2 text-xs">
                        No STNK  &emsp;&emsp;&emsp;&emsp;&emsp; : 
                      <span class="text-dark ms-sm-2 font-weight-bold">
                      <?php echo $data_billing['no_stnk'];  ?> 
                      </span></span>

                      <span class="mb-2 text-xs">
                        Total harga &emsp;&emsp;&emsp;&emsp;: 
                      <span class="text-dark ms-sm-2 font-weight-bold">
                      <?php echo $data_billing['total_harga'];  ?> 
                      </span></span> 
                  </div>
                </li>   
              </ul>
